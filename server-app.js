...
const GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwQp5kS5JScbeHkJvhoQeFGEcVHwiV55IXE0ktJVHapDCePqNQTtGPMzHMFxl0zSwxqTg/exec'; // Replace with your deployed script URL
...
async function submitSurveyToGoogleDrive(data) {
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            window[callbackName] = function(response) {
                ...
                if (response && response.success) {
                    ...
                    reject(new Error(response ? (response.error || 'Backend service returned an error') : 'Invalid response'));
                }
            };
            ...
            script.onerror = function() {
                ...
                delete window[callbackName];
                reject(new Error('Google Apps Script not accessible. Please check the URL and deployment status.'));
            };
        ...
        if (errorMessage.includes('not accessible') || errorMessage.includes('Failed to load script')) {
